...
Section PROOF.
  ...
  Definition GlobalStb0: gname -> option fspec := to_stb [("e", e_spec0); ("f", f_spec0); ("g", g_spec0)].
  Definition GlobalStb1: gname -> option fspec := to_stb [("e", e_spec1); ("f", f_spec1); ("g", g_spec1)].
