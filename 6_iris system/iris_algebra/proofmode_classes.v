...
Proof. unfold IsOp', IsOp. intros -> ->. rewrite pair_op. done. Qed.
Global Instance is_op_pair_core_id_l {A B : cmra} (a : A) (a' b1' b2' : B) :
  CoreId a → IsOp a' b1' b2' → IsOp' (a,a') (a,b1') (a,b2').
Proof. unfold IsOp', IsOp. intros C ->. rewrite -pair_op. by rewrite -core_id_dup. Qed.
...
Proof. unfold IsOp', IsOp. intros ->. rewrite Some_op. done. Qed.
